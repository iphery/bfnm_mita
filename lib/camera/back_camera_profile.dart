...
class ProfileCameraBackScreen extends StatefulWidget {
  const ProfileCameraBackScreen({Key key}) : super(key: key);

  @override
  ProfileCameraBackScreenState createState() => ProfileCameraBackScreenState();
}

class ProfileCameraBackScreenState extends State<ProfileCameraBackScreen>
