...
class OutstandingCMScreen extends StatefulWidget {

  @override
  _OutstandingCMScreenState createState() => _OutstandingCMScreenState();
}

class _OutstandingCMScreenState extends State<OutstandingCMScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Outstanding', style: TextStyle(color: Colors.black),),
      ...
      body: Column(
        children: [
          SizedBox(
            height: 50,
            child: FutureBuilder(
              future: dioService.loadCategoryOutstanding(),
          ...
          Expanded(
            child: FutureBuilder(
              future: dioService.getOutstandingData(keyword),
              builder: (context, snapshot){
                if(snapshot.hasData){
