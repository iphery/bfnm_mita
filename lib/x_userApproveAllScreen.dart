...
class UserApproveAllScreen extends StatefulWidget {
  @override
  _UserApproveAllScreenState createState() => _UserApproveAllScreenState();
}

class _UserApproveAllScreenState extends State<UserApproveAllScreen> {
                  ...
                  InkWell(
                    onTap: () async {
                      ...
                      if (rating > 0.0) {
                        ...
                        var res = await dioService.getUserApproveAll(
                            rating.toStringAsFixed(1), user.uid);
                        if (res == 'OK') {
                          setState(() {
                            isLoading = false;
                          });
