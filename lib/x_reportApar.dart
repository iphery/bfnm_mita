...
class ReportApar extends StatefulWidget {

  final String id;
  final String step;
  final int userLevel;
  ReportApar({this.id, this.step, this.userLevel});

  @override
  _ReportAparState createState() => _ReportAparState();
}

class _ReportAparState extends State<ReportApar> {
  String urlPDFPath = "";
  bool exists = true;
  int _totalPages = 0;
  int _currentPage = 0;
                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      onTap: ()async{
                        ...
                        if(RegExp(r'RA').hasMatch(widget.id)){
                          ///apar
