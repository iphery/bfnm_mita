...
class ReportPeerScreen extends StatefulWidget {



  @override
  _ReportPeerState createState() => new _ReportPeerState();
}

class _ReportPeerState extends State<ReportPeerScreen> {
          ...
          children: [
            WebView(
             // initialUrl: 'https://mita.balifoam.com/form8/indexPM.php?y=${widget.tahun}&m=${widget.bulan}',
              initialUrl: 'https://mita.balifoam.com/mobile/flutter/checklist/log_peer.php?id=${user.uid}',
